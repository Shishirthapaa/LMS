...
import "../Css/Instructorlibrary.css";
import React, { useState } from 'react';
import axios from 'axios';
import SearchIcon from '@mui/icons-material/Search';

function InstructorLibrary() {
    ...
    return (
        <>
            ...
            <div className="instsiderrr" style={{ filter: booksModal ? 'blur(5px)' : 'none', pointerEvents: booksModal ? 'none' : 'auto' }}>
                <Instructornavbar />
            </div>
            <div className="instliball" style={{ filter: booksModal ? 'blur(5px)' : 'none', pointerEvents: booksModal ? 'none' : 'auto' }}>
                <div className='instlibinfo'>
                    <div className='instlibsearch'>
                ...
                {searchResults.length === 0 ? (
                    <div className='instlibbookcard'>
                        <div className='instlibrec'>
                            <h5 className='instlibrectext'>Recommended</h5>
                        </div>
                        <div className='instlibrecbooks'>
                            {staticBooks.map((book) => (
                                <div className='bookscard' key={book.id} onClick={() => handleOpenBooksModal(book)}>
                                    ...
                                    <div className='bookscardbottom'>
                                        <p className='instbookstitle'>{book.title}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className='instlibbookcard'>
                        <div className='instlibrec'>
                            <h5 className='instlibrectext'>Search Results: </h5>
                        </div>
                        <div className='instlibrecbooks'>
